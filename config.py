...
OWNER_USERNAME = getenv("OWNER_USERNAME","Paracetamol650mge")
BOT_USERNAME = getenv("BOT_USERNAME" , "Sohini_music_bot")
BOT_NAME = getenv("BOT_NAME" , "RISHU")
ASSUSERNAME = getenv("ASSUSERNAME" , "MusicAssistOf_Sohini")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Tbf_Chat")
